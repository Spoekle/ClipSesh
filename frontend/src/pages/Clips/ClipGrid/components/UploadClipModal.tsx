      ...
      <div className="flex justify-center mb-4">
        <div className="inline-flex rounded-md shadow-sm" role="group">
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-l-lg ${uploadMethod === 'file'
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-r-lg ${uploadMethod === 'link'
              ? 'bg-blue-500 text-white'
              : 'bg-neutral-300 text-neutral-800 dark:bg-neutral-700 dark:text-neutral-200'
              } flex items-center`}
            disabled={uploading}
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-y-auto p-4">
          ...
          <motion.div
            ...
            className="relative bg-white dark:bg-neutral-800 rounded-2xl shadow-2xl w-full max-w-lg z-10 border border-neutral-200/50 dark:border-neutral-700/50"
          >
            {/* Header */}
            ...
            {/* Body */}
            <div className="p-6 text-neutral-800 dark:text-neutral-200 max-h-[70vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-2.5 bg-neutral-50 dark:bg-neutral-700 border border-neutral-200 dark:border-neutral-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                ...
                {uploadMethod === 'file' && (
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-sm text-neutral-600 dark:text-neutral-400 file:mr-3 file:py-2.5 file:px-4
                      ...
                      hover:file:bg-blue-100 dark:hover:file:bg-neutral-600 file:transition-colors"
                      accept="video/*"
                      disabled={uploading}
                ...
                <div className="flex justify-end space-x-3 pt-4 border-t border-neutral-200 dark:border-neutral-700 mt-2">
                  <button
                    ...
                    className="px-5 py-2.5 bg-neutral-100 dark:bg-neutral-700 text-neutral-800 dark:text-neutral-200 rounded-xl hover:bg-neutral-200 dark:hover:bg-neutral-600 transition-colors font-medium"
                    disabled={uploading}
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="px-5 py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors flex items-center font-medium"
                    disabled={uploading}
                  >
                    {uploading ? (
                      <>
