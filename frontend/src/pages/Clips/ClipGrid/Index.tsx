...
const ClipGrid: React.FC<ClipGridProps> = ({
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[300px] w-full">
        <div className="flex flex-col items-center justify-center gap-4">
          <div className="animate-spin rounded-full h-12 w-12 border-4 border-neutral-300 dark:border-neutral-600 border-t-blue-600"></div>
  ...
  if (filteredClips.length === 0 && !isLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[300px] bg-white/80 dark:bg-neutral-800/80 backdrop-blur-sm rounded-xl shadow-sm border border-neutral-200/80 dark:border-neutral-700/50 p-8">
        <div className="text-6xl mb-4">😢</div>
        <h2 className="text-xl font-semibold text-neutral-700 dark:text-neutral-300 mb-2">No Clips Found</h2>
        <p className="text-neutral-600 dark:text-neutral-400 text-center max-w-lg">
          {filterRatedClips
            ...
            : "No clips match your current filters. Try adjusting your search settings."}
        </p>
      </div>
    );
  }
