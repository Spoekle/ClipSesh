...
const ClipItem: React.FC<ClipItemProps> = ({
  ...
  return (
    <motion.div
      className="flex flex-col h-full bg-white/80 dark:bg-neutral-800/60 backdrop-blur-sm rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-200 border border-neutral-200/80 dark:border-neutral-700/50 relative"
    >
      ...
      >
        ...
        {hasRated && userRating && (
          <motion.div
            ...
            className={`absolute top-3 right-3 text-white px-3 py-1.5 rounded-md font-bold text-sm shadow-lg flex items-center gap-1.5 ${userRating === '1' ? 'bg-green-600' :
