  ...
  return (
    <div className='w-full'>
      <div className="bg-white/80 dark:bg-neutral-800/80 backdrop-blur-sm rounded-2xl shadow-lg border border-neutral-200/50 dark:border-neutral-700/50 p-6 mb-8">
        ...
        {loading ? (
          <div className="flex justify-center items-center h-64 bg-neutral-50 dark:bg-neutral-700 rounded-xl border border-neutral-200 dark:border-neutral-600">
            <motion.div
              animate={{ rotate: 360 }}
          ...
          <div className="flex flex-col justify-center items-center h-64 bg-neutral-50 dark:bg-neutral-700 rounded-xl border border-neutral-200 dark:border-neutral-600">
          ...
          <div className="w-full h-64 sm:h-80 bg-neutral-50 dark:bg-neutral-700 rounded-xl p-4 border border-neutral-200 dark:border-neutral-600">
        ...
        {!loading && data.length > 0 && (
          ...
          >
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border border-blue-200 dark:border-blue-700/50 flex flex-col items-center justify-center hover:shadow-md transition-shadow duration-200">
            ...
            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-xl border border-green-200 dark:border-green-700/50 flex flex-col items-center justify-center hover:shadow-md transition-shadow duration-200">
            ...
            <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-xl border border-purple-200 dark:border-purple-700/50 flex flex-col items-center justify-center hover:shadow-md transition-shadow duration-200 sm:col-span-2 lg:col-span-1">
