...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-neutral-50/50 dark:bg-neutral-900/30" />
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6">
              <div>
                <motion.h1
                  ...
                  className="text-4xl lg:text-5xl font-bold text-neutral-900 dark:text-white mb-3"
                >
                  {profile.username}
                </motion.h1>
                ...
                >
                  {profile.roles.map((role, index) => (
                    <motion.div
                      ...
                      className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-neutral-100 dark:bg-neutral-700 border border-neutral-200 dark:border-neutral-600 shadow-sm"
                    >
                      {getRoleIcon([role])}
              ...
              {isOwnProfile && (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={onEditClick}
                  className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold shadow-md hover:shadow-lg transition-all duration-200 flex items-center gap-2 self-center lg:self-start"
                >
                  <FaEdit />
                  Edit Profile
                </motion.button>
            ...
            >
              {profile.discordId && profile.discordUsername && (
                <div className="bg-indigo-50 dark:bg-indigo-950/30 rounded-xl p-4 border border-indigo-200/50 dark:border-indigo-800/50">
