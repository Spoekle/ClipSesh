      ...
      {isEditModalOpen && (
        ...
        >
          <motion.div
            ...
            className="modal-content relative bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white w-full max-w-lg rounded-2xl shadow-2xl max-h-[90vh] overflow-hidden border border-neutral-200/50 dark:border-neutral-700/50"
          >
            {/* Header */}
            <div className="flex justify-between items-center p-6 border-b border-neutral-200 dark:border-neutral-700">
              ...
              <button
                onClick={handleClose}
                className="p-2 text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700 rounded-xl transition-colors"
                aria-label="Close"
              >
              ...
              <form onSubmit={handleUpdate} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2.5 rounded-xl bg-neutral-50 dark:bg-neutral-700 border ${errors.streamer
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl bg-neutral-50 dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    disabled={isLoading}
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2.5 rounded-xl bg-neutral-50 dark:bg-neutral-700 border ${errors.title
                      ? 'border-red-500 dark:border-red-500'
                      : 'border-neutral-300 dark:border-neutral-600'
                      } focus:outline-none focus:ring-2 focus:ring-blue-500`}
                    disabled={isLoading}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2.5 rounded-xl bg-neutral-50 dark:bg-neutral-700 border ${errors.link
                      ? 'border-red-500 dark:border-red-500'
                      : 'border-neutral-300 dark:border-neutral-600'
                      } focus:outline-none focus:ring-2 focus:ring-blue-500`}
                    disabled={isLoading}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2.5 rounded-xl bg-neutral-50 dark:bg-neutral-700 border ${errors.submitterId
                      ? 'border-red-500 dark:border-red-500'
                      : 'border-neutral-300 dark:border-neutral-600'
                      } focus:outline-none focus:ring-2 focus:ring-blue-500`}
                    disabled={isLoading}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2.5 rounded-xl bg-neutral-50 dark:bg-neutral-700 border ${errors.year
                      ? 'border-red-500 dark:border-red-500'
                      : 'border-neutral-300 dark:border-neutral-600'
                      } focus:outline-none focus:ring-2 focus:ring-blue-500`}
                    disabled={isLoading}
                ...
                <div className="flex justify-end space-x-3 pt-4 border-t border-neutral-200 dark:border-neutral-700 mt-2">
                  <button
                    type="button"
                    onClick={handleClose}
                    className="px-5 py-2.5 bg-neutral-100 dark:bg-neutral-700 text-neutral-800 dark:text-white rounded-xl hover:bg-neutral-200 dark:hover:bg-neutral-600 transition-colors font-medium"
                    disabled={isLoading}
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors disabled:opacity-70 font-medium"
                    disabled={isLoading}
                  >
                    {isLoading ? (
